  ...
  const allSlides = useMemo(() => {
    const slides = user
      ? (() => {
          ...
          return personal
            ? [
                { src: imgUrl(personal.path), srcset: imgSrcSet(personal.path), alt: personal.alt },
                ...baseSlides,
              ]
            : baseSlides
        })()
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            whileTap={
              user
                ? { scale: 0.97, transition: { type: 'spring', stiffness: 500, damping: 15 } }
                : undefined
            }
      ...
      {!user ? (
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              ...
              >
                <svg
                  className="w-4 h-4 text-cream/50 shrink-0"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth={1.5}
              ...
              <span className="flex items-center gap-2">
                <motion.button
                  ...
                  className="text-cream/40 disabled:opacity-30 disabled:cursor-wait"
        ...
        >
          <div className="text-center">
            <p className="text-cream font-heading text-2xl leading-normal py-1">
