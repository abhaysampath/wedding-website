...
export default function Hero() {
  ...
  const allSlides = useMemo(() => {
    if (!user) return baseSlides
    const personal = user.side === 'groom'
      ? heroConfig.personalized.groom
      : user.side === 'bride'
        ? heroConfig.personalized.bride
        : null
    if (!personal) return baseSlides
    return [{ src: heroConfig.dir + personal.file, alt: personal.alt }, ...baseSlides]
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-between min-h-screen w-full px-6 pointer-events-none">
        <div className="flex flex-col items-center pt-[12vh] pointer-events-auto">
          <motion.p
        ...
        {!user && (
          <motion.div
            ...
            className="w-full max-w-sm pb-[15vh] pointer-events-auto"
          >
            <div
        ...
        {user && (
          <motion.p
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.8 }}
            className="text-cream/70 text-base md:text-lg italic font-heading pb-[15vh] pointer-events-auto"
          >
